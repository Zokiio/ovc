...
public class PlayerJoinEventSystem extends HolderSystem<EntityStore> {
    ...
    public PlayerJoinEventSystem(PlayerPositionTracker positionTracker, OVCPlugin plugin) {
    ...
    public void onEntityRemoved(@Nonnull Holder<EntityStore> holder,
        ...
        if (playerRef != null) {
            ...
            try {
                com.zottik.ovc.plugin.gui.VoiceChatPage.removePlayerPage(playerUUID);
            } catch (Exception e) {
